...
enum BIO_WeaponModFlags : uint
{
	...
	BIO_WMODF_KICKBACK_INC = 1 << 1,
	BIO_WMODF_KICKBACK_DEC = 1 << 2,
	BIO_WMODF_SWITCHSPEED_INC = 1 << 3,
	BIO_WMODF_SWITCHSPEED_DEC = 1 << 4,
	BIO_WMODF_AMMOTYPE = 1 << 5,
	BIO_WMODF_MAGTYPE = 1 << 6,
	BIO_WMODF_MAGSIZE_INC = 1 << 7,
	BIO_WMODF_MAGSIZE_DEC = 1 << 8,
	// Timing
	BIO_WMODF_FIRETIME_INC = 1 << 9,
	BIO_WMODF_FIRETIME_DEC = 1 << 10,
	BIO_WMODF_RELOADTIME_INC = 1 << 11,
	BIO_WMODF_RELOADTIME_DEC = 1 << 12,
	// Pipeline, general
	BIO_WMODF_PAYLOAD_NEW = 1 << 13,
	BIO_WMODF_PAYLOAD_ALTER = 1 << 14,
	BIO_WMODF_SHOTCOUNT_INC = 1 << 15,
	BIO_WMODF_SHOTCOUNT_DEC = 1 << 16,
	BIO_WMODF_DAMAGE_INC = 1 << 17,
	BIO_WMODF_DAMAGE_DEC = 1 << 18,
	BIO_WMODF_SPREAD_INC = 1 << 19,
	BIO_WMODF_SPREAD_DEC = 1 << 20,
	BIO_WMODF_SPLASHDAMAGE_INC = 1 << 21,
	BIO_WMODF_SPLASHDAMAGE_DEC = 1 << 22,
	BIO_WMODF_SPLASHRADIUS_INC = 1 << 23,
	BIO_WMODF_SPLASHRADIUS_DEC = 1 << 24,
	BIO_WMODF_PROJSPEED_INC = 1 << 25,
	BIO_WMODF_PROJSPEED_DEC = 1 << 26,
	// Pipeline, melee-exclusive
	BIO_WMODF_LIFESTEAL_INC = 1 << 27,
	BIO_WMODF_LIFESTEAL_DEC = 1 << 28,
	BIO_WMODF_MELEERANGE_INC = 1 << 29,
	BIO_WMODF_MELEERANGE_DEC = 1 << 30
}
